...
def newemail( subject = "", body = "", files = [], me = False ):
    ...
    if me:
        recipients = ['wsheppard@witekio.com','sheppard.will@gmail.com']
    else:
        recipients = ['wsheppard@witekio.com','amurray@witekio.com','elangley@witekio.com', 'jeremyr@ovation.co.uk']
...
def doemail( subject = "", body = "", files = [] ):
    fromaddr = "wsheppard@witekio.com"
    #recipients = ['wsheppard@witekio.com','amurray@witekio.com','elangley@witekio.com', 'jeremyr@ovation.co.uk']
    recipients = ['wsheppard@witekio.com','amurray@witekio.com','elangley@witekio.com']
