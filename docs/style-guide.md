...
If you are writing something that is not specifically related to the project you are working on, then maybe this code would be a good addition to the `pluma` core codebase, rather than the repository for the project.  
...
from pluma.core.baseclasses.consolebase import ConsoleLoginFailedError
from pluma.core.board import BoardBootValidationError
