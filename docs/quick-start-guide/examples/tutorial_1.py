...
bbb  = farm.Board(name='bbb',  pdu_port=pdu1[7], hub='1-1.1.1')
fb42 = farm.Board(name='fb42', pdu_port=pdu1[4], hub='1-1.1.2')
fb43 = farm.Board(name='fb43', pdu_port=pdu1[6], hub='1-1.1.3')
